        ...
        <div className="flex items-center space-x-4">
          ...
          <div ref={accountRef} className="relative">
            <button
              ...
              className="flex items-center space-x-2 p-2 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
            >
              <img
                src={user.fotoUrl}
                alt="user photo"
            ...
            {accountOpen && (
              <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
                ...
                >
                  <span
                    className="w-full text-left flex items-center px-4 pt-2 pb-1 text-xs text-gray-500"
                    role="menuitem"
                  >
                    Conectado como
                  </span>
                  <span
                    className="w-full text-left flex items-center px-4 pb-2 text-sm text-gray-800 font-medium border-b mb-1"
                    role="menuitem"
                  >
