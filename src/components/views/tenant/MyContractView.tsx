...
const formatDate = (dateString: string) => {
    ...
    return new Date(date.getTime() + userTimezoneOffset).toLocaleDateString('es-ES', { day: '2-digit', month: 'long', year: 'numeric' });
};
    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-md text-gray-600">
          Detalles del acuerdo para la propiedad: <span className="font-semibold">{property.title}</span>.
        </p>
      </header>
