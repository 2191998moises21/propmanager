...
export const PropertyDetail: React.FC<PropertyDetailProps> = ({
  ...
  const handleTerminate = () => {
    if (
      contract &&
      window.confirm(
        `¿Está seguro que desea terminar el contrato para ${tenant?.nombre_completo} en esta propiedad? La propiedad pasará a estar disponible.`
      )
    ) {
  ...
  const handleDelete = () => {
    ...
    if (
      window.confirm(
        `¿Está seguro que desea eliminar la propiedad "${property.title}"? Esta acción no se puede deshacer.`
      )
    ) {
  ...
  const StatusChanger: React.FC = () => {
    if (property.estado_ocupacion === OccupancyStatus.Ocupada) {
      return (
        <Badge
          text={property.estado_ocupacion}
          color={getStatusBadgeColor(property.estado_ocupacion)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label htmlFor="precio_alquiler" className="block text-sm font-medium text-gray-700">
                Precio de Alquiler ({formData.moneda})
              </label>
              <input
                type="number"
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center space-x-2 flex-shrink-0">
                ...
                <Button
                  ...
                  disabled={property.estado_ocupacion === OccupancyStatus.Ocupada}
              ...
              <Card>
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      property.amenidades || '<p>No hay descripción detallada disponible.</p>',
                  }}
                />
              </Card>
            </div>
            ...
            <div className="space-y-6">
              <Card>
                ...
                <div className="space-y-4">
                  ...
                  />
                  <DetailItem
                    icon={<BuildingOfficeIcon className="transform -scale-x-100" />}
                    label="Baños"
                  ...
                  {property.estado_ocupacion === OccupancyStatus.Disponible &&
                    property.fecha_disponible && (
                      <DetailItem
                        ...
                        value={new Date(property.fecha_disponible).toLocaleDateString('es-ES')}
                      />
                    )}
                </div>
              </Card>
              ...
              <Card>
                ...
                <div className="space-y-4">
                  <DetailItem
                    ...
                    value={formatCurrency(property.precio_alquiler)}
                  />
                  <DetailItem
                    icon={<CurrencyDollarIcon />}
                    label="Depósito Requerido"
                    value={
                      property.deposito_requerido
                        ? formatCurrency(property.deposito_requerido)
                        : 'N/A'
                    }
                  />
                </div>
              ...
              {property.estado_ocupacion === OccupancyStatus.Ocupada && tenant && contract ? (
                  ...
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Contrato hasta {new Date(contract.fecha_fin).toLocaleDateString('es-ES')}
                      </p>
                      <button
                ...
                <Card className="text-center">
                  ...
                  <p className="text-sm text-gray-500 mt-1 mb-4">
                    Asigne un inquilino para crear un nuevo contrato de alquiler.
                  </p>
                ...
                <Card className="text-center">
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Esta propiedad no está disponible para alquiler actualmente.
                  </p>
                </Card>
              )}
            </div>
