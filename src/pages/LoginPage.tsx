...
export const LoginPage: React.FC = () => {
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    if (!success) {
      setError(hookError || 'Email o rol incorrecto. Por favor, intente de nuevo.');
    }
  };
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    if (!success) {
      setRegError(hookError || 'El correo electrónico ya está en uso.');
    }
  };
        ...
        <form onSubmit={handleRegisterSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              disabled={isLoading}
              className="mt-1 appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
            />
          </div>
          <div>
          ...
          <div>
            <label htmlFor="regPhone" className="block text-sm font-medium text-gray-700">
              Teléfono
            </label>
            <input
              id="regPhone"
          ...
          <div>
            <label htmlFor="regAddress" className="block text-sm font-medium text-gray-700">
              Dirección
            </label>
            <input
              id="regAddress"
